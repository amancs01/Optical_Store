...
import { CalendarCheck, CircleUser, LayoutDashboard, LogIn, LogOut, Menu, Package, Search, ShoppingBag, ShoppingCart, UserPlus, X } from "lucide-react";
    ...
    <header className="sticky top-0 z-[1000] border-b border-slate-200 bg-white/95 backdrop-blur">
      <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-3 sm:h-16 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/products"
            className="inline-flex h-10 w-10 items-center justify-center rounded-md border border-slate-200 hover:bg-slate-50 lg:hidden"
            aria-label="Search"
          >
          ...
          <Link
            ...
            className={cn(
              "relative hidden h-10 w-10 items-center justify-center rounded-md border border-slate-200 hover:bg-slate-50 lg:inline-flex",
