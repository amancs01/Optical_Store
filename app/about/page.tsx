        ...
        <div>
          ...
          <div className="mt-6 grid gap-3 text-sm text-slate-700 sm:grid-cols-2">
            <div className="rounded-md border border-slate-200 bg-white p-4 shadow-sm">
              <p className="text-xs font-black uppercase text-teal-700">Location</p>
              <p className="mt-2 font-semibold">{SITE_CONFIG.address}</p>
            </div>
            <div className="rounded-md border border-slate-200 bg-white p-4 shadow-sm">
              <p className="text-xs font-black uppercase text-teal-700">Store hours</p>
              <p className="mt-2 font-semibold">{SITE_CONFIG.openingHours}</p>
            </div>
          </div>
        </div>
        <div className="relative min-h-[240px] overflow-hidden rounded-md border border-slate-200 bg-white shadow-sm sm:min-h-[360px]">
          <Image
